...
export interface PageQuery_allMarkdownRemark_nodes_frontmatter_featuredImage_childImageSharp_fluid {
  base64: string | null;
  aspectRatio: number;
  src: string;
  srcSet: string;
...
export interface PageQuery_allMarkdownRemark_nodes_frontmatter_featuredImage_childImageSharp {
  fluid: PageQuery_allMarkdownRemark_nodes_frontmatter_featuredImage_childImageSharp_fluid | null;
}

export interface PageQuery_allMarkdownRemark_nodes_frontmatter_featuredImage {
  childImageSharp: PageQuery_allMarkdownRemark_nodes_frontmatter_featuredImage_childImageSharp | null;
}
...
export interface PageQuery_allMarkdownRemark_nodes_frontmatter {
  ...
  featuredImage: PageQuery_allMarkdownRemark_nodes_frontmatter_featuredImage | null;
}
